...
Notice the `:root` pseudo-class selector, we can declare our variable globally using it. We can as well declare them using other selectors, they will be then be scoped in these ones.
